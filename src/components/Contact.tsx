        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-14">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-7 py-3 border border-outline hover:border-primary/50 text-on-surface-secondary hover:text-on-surface font-medium rounded-xl transition-colors text-sm w-full sm:w-auto justify-center"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
